...
def frame(image_path,before_last, base_x=100, base_y=100, base_z=100, server_path):
    """
...
def frame_mcfunction(image_path,before_last, base_x=100, base_y=100, base_z=100, server_path):
    """
    将图片转换为Minecraft文本展示实体指令（每行像素生成一个实体）
    image_path: 图片路径
    base_x/y/z: 生成实体的基准坐标
